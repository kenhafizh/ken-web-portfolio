    ...
    <section id="testimonials">
      <div className="w-full bg-white dark:bg-slate-800 overflow-hidden">
        <div className="text-center py-24">
          ...
          <h1 className="text-center text-slate-900 dark:text-white mt-4 text-sm font-light">
            Nice things people have said about me:
          </h1>

          <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12 px-6 md:px-12 mt-12 max-w-6xl mx-auto">
            <div className="rounded-2xl bg-slate-200 dark:bg-slate-600 p-8 md:p-10 flex flex-col items-center max-w-sm w-full">
              ...
              <p className="text-slate-700 dark:text-white text-sm md:text-base leading-relaxed text-center font-light">
              ...
              <div className="text-center mt-10 flex flex-col items-center">
                <h1 className="text-slate-900 dark:text-white font-semibold text-xl">
                  Sugeng Dalu
                </h1>
                <p className=" font-light text-slate-600 dark:text-slate-300 text-sm">
                  Chief Executive Officer - ZMI
                </p>
              </div>
            </div>
            <div className="rounded-2xl bg-slate-200 dark:bg-slate-600 p-12 flex flex-col items-center max-w-sm w-full">
              <div className="w-16 h-16 rounded-full mb-6 overflow-hidden">
                <img
